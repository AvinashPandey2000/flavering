        ...
        <View style={styles.overlay}>
          <TouchableWithoutFeedback>
            <View style={styles.modalContent}>
              ...
              <TouchableOpacity
                style={styles.option}
                onPress={() => console.log('Vaccinations')}
              >
              ...
              {CURRENT_ENV == 'one' && (
                <>
                  <TouchableOpacity
                    ...
                    onPress={() => console.log('My Pets')}
                  >
                    <Text style={styles.optionText}>Resources</Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => console.log('My Pets')}
                  >
                    <Text style={styles.optionText}>Our services</Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => console.log('My Pets')}
                  >
                    <Text style={styles.optionText}>Enroll your pet</Text>
                  </TouchableOpacity>
                </>
              )}
              ...
              {CURRENT_ENV == 'two' && (
                <>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => console.log('My Pets')}
                  >
                    <Text style={styles.optionText}>online pharmacy </Text>
                  </TouchableOpacity>
                </>
              )}
